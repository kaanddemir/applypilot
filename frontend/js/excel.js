...
const EXPORT_COLUMNS = [
  ...
  { header: "Source", width: 16, get: (a) => (a.sources?.length ? a.sources : (a.source ? [a.source] : [])).join("\n") },
  { header: "Job URL", width: 34, get: (a) => (a.jobUrls?.length ? a.jobUrls : (a.jobUrl ? [a.jobUrl] : [])).join("\n") },
